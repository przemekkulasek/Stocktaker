package pl.me.inwentaryzacja.webapiDA;
...
public class JSONHttpClient {
    ...
    public <T> OperationLog[] PostObject(String url, List<NameValuePair> params, final T object, final Class<T> objectClass) throws IOException {
        DefaultHttpClient defaultHttpClient = new DefaultHttpClient();
        ...
        if (httpEntity != null) {
            ...
            String resultString = convertStreamToString(inputStream);
            inputStream.close();
            return new GsonBuilder().create().fromJson(resultString, OperationLog[].class);
        }
    ...
    public <T> T Get(String url, List<NameValuePair> params, final Class<T> objectClass) throws IOException {
        DefaultHttpClient defaultHttpClient = new DefaultHttpClient();
